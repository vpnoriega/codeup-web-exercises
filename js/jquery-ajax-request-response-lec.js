...
$(document).ready(function(){
     ...
     */
    var hookbinUrl = 'https://hookb.in/dmZa3lK1N6T9RRzPgJlD';
...
$.ajax(hookbinUrl,{
    method: "POST",
    // data: car //form data
    data: JSON.stringify(car) //this will send it in json
    });
...
myBooks.always(onAlways)
     ...
     */
// to make it fail, I typed 'film' instead of 'films'
...
// books.request.done(function (data){
