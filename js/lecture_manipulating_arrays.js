...
/* These functions modify the array (mutate it)
...
// find index of first matching result in array - these don't manipulate, only give values
...
// function pieNames (array){
//     return array.slice(3) // or array.slice(array.length -3)
// }
// console.log(pieNames(pies))
// using return pies.slice(3) only limits the slice to that specific variable
...
// pies.sort();
// even if you: var originalpies = pies; , it'll just copy it, not reassign it
